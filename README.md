...
- 🔧 **Focus**: Low-level motor and sensors interfacing, real-time control, and high-level task planning  
- 🧪 **Technologies**: Embedded C/C++, ROS, industrial communication protocols (e.g., RS485, Modbus, etc.)  
- 🎓 **Goal**: Gain industry-ready experience and contribute to open robotic systems

---

pre lang="markdown"> ## 🔍 Project Structure ``` low_level_control/ - Firmware and hardware interface for motors/sensors high_level_control/ - ROS nodes, planners, and control strategies docs/ - Documentation and setup guides LICENSE README.md ``` </pre>
