    ...
    while (1) {
        ...
        if (reg_info.type & (MB_EVENT_HOLDING_REG_WR | MB_EVENT_HOLDING_REG_RD)) {
           ...
           motor_params_t param = {
            ...
            gpio_set_level(BUILT_IN_LED, param.direction);
           portEXIT_CRITICAL(&param_lock);
           ESP_LOGI(TAG, "received %.3f degree, %d direction, %0.2f delay.", param.target_angle_deg, param.direction, param.half_period_us);
        }
...
// #define MB_SLAVE_ADDR    3               //7->esp(1)  //3->esp(2)  // 1->esp(3)     
// #define MB_DEV_SPEED    115200       
// #define LED_GPIO 2
...
//            portEXIT_CRITICAL(&param_lock);
//            gpio_set_level(LED_GPIO, curr_led_state);
